...
class OrdersCanceledByAdminController extends GetxController {
  OrderscompletedViewData ordersCanceledByAdminData = OrderscompletedViewData(Get.find());
  ...
  getOrders() async {
    ...
    update();
    var response = await ordersCanceledByAdminData.getOrdersCanceledByAdmin();
