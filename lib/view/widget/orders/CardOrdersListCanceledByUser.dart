...
import '../../../linkapi.dart';
class CardOrdersListCanceledByUser extends GetView<OrdersCanceledByUserController> {
  final OrdersModel listdata;

  const CardOrdersListCanceledByUser({Key? key, required this.listdata})
      : super(key: key);
